...
The process will ask for your Koii wallet path and may cause amount of KOII. Check our [Koii CLI Tool](https://docs.koii.network/koii-software-toolkit-sdk/using-the-cli) to generate a Koii Wallet. Also Check our [Faucet tutorial](https://docs.koii.network/koii-software-toolkit-sdk/wallet-and-faucet) to airdrop some KOII into your wallet.
